"""GitHubResolver — résolveur générique pour tout dépôt GitHub contenant des skills.

Effectue un parcours récursif des fichiers SKILL.md (ou skill.md)
n'importe où dans le répertoire de cache.
"""
...
class GitHubResolver(SourceResolver):
    """Résolveur générique pour tout dépôt GitHub contenant des fichiers SKILL.md."""
